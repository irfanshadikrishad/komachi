  ...
  return (
    <>
      ...
      <section className="container">
        <div className={styles.tandc_Main}>
          ...
          <p className={styles.tandc_p}>
            ...
            contained on Komachi Anime's Website; remove any copyright or other
            ...
            server. This will let Komachi Anime to terminate upon violations of
            ...
            Service Generator and the Privacy Policy Generator.
          </p>
          ...
          <p className={styles.tandc_p}>
            ...
            Komachi Anime does not make any representations concerning the
          ...
          <p className={styles.tandc_p}>
            ...
            materials on Komachi Anime&apos;s Website, even if Komachi Anime or
          ...
          <p className={styles.tandc_p}>
            ...
            complete, or current. Komachi Anime may change the materials
            contained on its Website at any time without notice. Komachi Anime
            does not make any commitment to update the materials.
          </p>
          <h3 className={styles.tandc_h3}>6. Links </h3>
          <p className={styles.tandc_p}>
            Komachi Anime has not reviewed all of the sites linked to its
            Website and is not responsible for the contents of any such linked
            site. The presence of any link does not imply endorsement by Komachi
            Anime of the site. The use of any linked website is at the
            user&apos;s own risk.
          </p>
          ...
          <p className={styles.tandc_p}>
            Any claim related to Komachi Anime's Website shall be governed by
            the laws of bq without regards to its conflict of law provisions.
          </p>
        </div>
      </section>
      <Footer />
